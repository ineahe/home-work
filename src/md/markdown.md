...
> _italic_ _em_ <br> > **bold** <br> > **strong** > ~~del~~
...
`(백틱) 기호를 3번 이상 입력하고 언어 이름을 명시해 코드 '블록(Block)'을 표현함.
`(백틱)의 시작 개수와 종료 개수는 같아야 함.
...
- 참조 링크 : 문장에서 참조 부분에 사이트를 연결하고자 할 때 사용.

```
[label]: 링크 "링크 설명"
```

> 문서 안에 [참조링크][1]를 사용할 수 있다.
> [1]: https://google.com
